...
def parse_args():
    ...
    parser.add_argument('--model_dir', default='./logs/fp/lr0.002_tr0', help='base directory to save logs')
    ...
    parser.add_argument('--seed', default=13, type=int, help='manual seed')
    ...
    def __init__(self, args, ratio):
        ...
        if args.kl_anneal_cyclical:
            ...
            for c in range(args.kl_anneal_cycle):
                v, i = 0.0, 0.0 
                while v <= 1.0 and (int(self.iter +c*period) < args.niter):
...
def main():
    ...
    kl_anneal = kl_annealing(args, ratio=0.5)
    ...
    # plot_log("train_record.txt", args)
